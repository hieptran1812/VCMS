        ...
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
          <div className="rounded-lg bg-zinc-100 p-6 dark:bg-zinc-900">
            ...
            <p className="text-zinc-600 dark:text-zinc-400">
              Contact us for support. I am looking forward to connecting with
              you.
            </p>
            <Link
              href="http://linkedin.com/in/hieptran01/"
              className="text-primary dark:text-primary-100"
            >
              Connect to my linkedin &rarr;
            </Link>
          </div>
          ...
          <div className="rounded-lg bg-zinc-100 p-6 dark:bg-zinc-900">
            ...
            <p className="text-zinc-600 dark:text-zinc-400">
              Don't hesitate! Connect for dedicated 1:1 support!
            </p>
            <Link
              href="http://linkedin.com/in/hieptran01/"
              className="text-primary dark:text-primary-100"
